...
# source(file)
setwd("~/Documents/stage_Stats/code/sanssouci")
...
barmus <- c(2, 100, 1000, 5)[1:3] # "taille de référence" du signal quand non-nul, 2, 3, 4 dans le papier
groupeds <- c(TRUE, FALSE)[1] # coller ensemble ou pas les feuilles avec du signal, TRUE dans le papier
settings <- c("const", "gauss", "poisson", "rgauss")[1] # forme des espérances des stats de test, rgauss dans le papier
